...
The multi-user backend now includes account deletion, verified remote export, active-device session revocation, hashed abuse limits, privacy-safe operational events, and scheduled retention. Independent security review and carrier approval for the actual product flow remain launch gates.
